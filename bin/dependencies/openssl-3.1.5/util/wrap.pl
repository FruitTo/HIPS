...
BEGIN {
    ...
    require '/home/fruitto/Project/engine/bin/dependencies/openssl-3.1.5/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/home/fruitto/Project/engine/bin/dependencies/openssl-3.1.5/test/fips-and-base.cnf';
    shift;
